...
openxlsx::write.xlsx(df_monolingual, "nbp_monolingualc_soft_rev_250213.xlsx")
...
openxlsx::write.xlsx(df_monolingual_strict, "nbp_monolingualc_strict_rev_250213.xlsx")
